...
aAdd( aSX2, { ;
	...
	'FTP EDI CLIENTES'														, ; //X2_NOME
	'FTP EDI CLIENTES'														, ; //X2_NOMESPA
	'FTP EDI CLIENTES'														, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	{ 'GETSX8NUM("SZ4","Z4_COD")'											, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 'Cliente'																, .T. }, ; //X3_TITSPA
	{ 'Cliente'																, .T. }, ; //X3_TITENG
	{ 'COD CLIENTE'															, .T. }, ; //X3_DESCRIC
	{ 'COD CLIENTE'															, .T. }, ; //X3_DESCSPA
	{ 'COD CLIENTE'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'OPERACAO'															, .T. }, ; //X3_DESCSPA
	{ 'OPERACAO'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'PERTENCE("DU")'														, .T. }, ; //X3_VLDUSER
	{ 'D=Download;U=Upload'													, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'SZ4'																	, .T. }, ; //X3_ARQUIVO
	{ '06'																	, .T. }, ; //X3_ORDEM
	{ 'Z4_DIRFTP'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Diret. FTP'															, .T. }, ; //X3_TITULO
	{ 'Diret. FTP'															, .T. }, ; //X3_TITSPA
	{ 'Diret. FTP'															, .T. }, ; //X3_TITENG
	{ 'DIRETORIO FTP'														, .T. }, ; //X3_DESCRIC
	{ 'DIRETORIO FTP'														, .T. }, ; //X3_DESCSPA
	{ 'DIRETORIO FTP'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZ4'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'Z4_DIRPROT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Dir.Protheus'														, .T. }, ; //X3_TITULO
	{ 'Dir.Protheus'														, .T. }, ; //X3_TITSPA
	{ 'Dir.Protheus'														, .T. }, ; //X3_TITENG
	{ 'DIRETORIO PROTHEUS'													, .T. }, ; //X3_DESCRIC
	{ 'DIRETORIO PROTHEUS'													, .T. }, ; //X3_DESCSPA
	{ 'DIRETORIO PROTHEUS'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZ4'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'Z4_SERVFTP'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Servidor FTP'														, .T. }, ; //X3_TITULO
	{ 'Servidor FTP'														, .T. }, ; //X3_TITSPA
	{ 'Servidor FTP'														, .T. }, ; //X3_TITENG
	{ 'SERVIDOR FTP'														, .T. }, ; //X3_DESCRIC
	{ 'SERVIDOR FTP'														, .T. }, ; //X3_DESCSPA
	{ 'SERVIDOR FTP'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZ4'																	, .T. }, ; //X3_ARQUIVO
	{ '09'																	, .T. }, ; //X3_ORDEM
	{ 'Z4_USERFTP'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Usuario FTP'															, .T. }, ; //X3_TITULO
	{ 'Usuario FTP'															, .T. }, ; //X3_TITSPA
	{ 'Usuario FTP'															, .T. }, ; //X3_TITENG
	{ 'USUARIO FTP'															, .T. }, ; //X3_DESCRIC
	{ 'USUARIO FTP'															, .T. }, ; //X3_DESCSPA
	{ 'USUARIO FTP'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Senha FTP'															, .T. }, ; //X3_TITULO
	{ 'Senha FTP'															, .T. }, ; //X3_TITSPA
	{ 'Senha FTP'															, .T. }, ; //X3_TITENG
	{ 'SENHA FTP'															, .T. }, ; //X3_DESCRIC
	{ 'SENHA FTP'															, .T. }, ; //X3_DESCSPA
	{ 'SENHA FTP'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZ4'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'Z4_EXTENSA'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Extensao Arq'														, .T. }, ; //X3_TITULO
	{ 'Extensao Arq'														, .T. }, ; //X3_TITSPA
	{ 'Extensao Arq'														, .T. }, ; //X3_TITENG
	{ 'EXTENSAO ARQUIVO'													, .T. }, ; //X3_DESCRIC
	{ 'EXTENSAO ARQUIVO'													, .T. }, ; //X3_DESCSPA
	{ 'EXTENSAO ARQUIVO'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Registro bloqueado'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
